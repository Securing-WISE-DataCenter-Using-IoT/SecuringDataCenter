        ...
        <div class="container-login100" style="background-image:url('assets/img/bg-01.jpg.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                <span class="login100-form-title p-b-41">
                    <span>WISE Data Center Room <br> Employee Page <br> </span>
                </span>
                ...
                <?php endif; ?>
                <form action="process.php" method="POST" class="login100-form validate-form p-b-33 p-t-5">
                    <br><br>
                    <div class="image-container">
                        <img class="my-image" src="assets/img/WISElogo.jpg" alt="Image description">
                    </div> <br><br>
                    <div class="wrap-input100 validate-input" data-validate="Enter username">
                        <input class="input100" type="text" name="UName" placeholder="Username" pattern="[A-Za-z]+" title="Username must contain only letters" required>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
					
						<input class="input100" type="password" name="Password" placeholder="Password" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*]).{8,}" title="Password must contain at least 8 characters, including at least one uppercase letter, one lowercase letter, one number, and one symbol (!@#$%^&*)" required oninvalid="setCustomValidity('Password must contain at least 8 characters, including at least one uppercase letter, one lowercase letter, one number, and one symbol')" onchange="try{setCustomValidity('')}catch(e){}">
